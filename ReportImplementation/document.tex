...
\DeclareCaptionLabelFormat{customlabel}{Hasanis 1.1}
\captionsetup[figure]{labelformat=customlabel, labelsep=period}

\DeclareCaptionLabelFormat{customlabel}{Hasanis 2.1}
\captionsetup[figure]{labelformat=customlabel, labelsep=period}
...
\begin{document}
	...
	\begin{titlepage}
		\centering
		\includegraphics[width=0.8\textwidth]{photos/aueb_logo.jpg}
		\vfill
