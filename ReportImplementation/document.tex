...
\begin{document}
	...
	\textcolor{red}{san simperasma mporoume na poume oti en groupparismena analoga me thn glossa pou miloun, koultoura klp afou thoroume oti en pou gitonikes xores j oloenna groupparountai oso afksanoume to resolution xoris omos touto na en kathoristiko afou ta featured channels enen mono pou  touto pou ginountai alla opos fainetai paizei simantiko rolo j h glossa tlk klp}
	
	\vspace{12pt}
	\vspace{12pt}
	\vspace{12pt}
	Αντίστοιχο αποτέλεσμα με άλλο community όπου να έχουν προστεθει κανάλια σύμφωνα με τη χώρα προέλευσης καναλιού ή την γλώσσα δεν παρατηρήθηκαν
	
	\vspace{12pt}
	\vspace{12pt}
	\vspace{12pt}
	Άρα παρατηρούμε πως τα κανάλια σε κάθε community είναι απο κοντινές χώρες έχουν κοινή γλώσσα που έχουν δημιουργηθεί είναι με βάση την χώρα για την οποία απευθύνονται τα κανάλια αφού βλέπουμε να είναι
